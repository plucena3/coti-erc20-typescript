...
export interface CAPIBARA_FIXEDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
  ...
  encodeFunctionData(
    functionFragment: "transfer(address,uint64)",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface CAPIBARA_FIXED extends BaseContract {
  connect(runner?: ContractRunner | null): CAPIBARA_FIXED;
  waitForDeployment(): Promise<this>;

  interface: CAPIBARA_FIXEDInterface;
  ...
  "transfer(address,uint64)": TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "transfer(address,uint64)"
  ): TypedContractMethod<
    [to: AddressLike, value: BigNumberish],
    [bigint],
    "nonpayable"
