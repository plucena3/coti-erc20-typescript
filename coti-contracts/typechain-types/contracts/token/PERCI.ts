...
export interface PERCIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
...
export interface PERCI extends BaseContract {
  connect(runner?: ContractRunner | null): PERCI;
  waitForDeployment(): Promise<this>;

  interface: PERCIInterface;
